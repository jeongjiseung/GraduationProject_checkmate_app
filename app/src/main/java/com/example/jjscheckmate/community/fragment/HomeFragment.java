...
import com.example.jjscheckmate.service.KoreanPhraseExtractorApi;
import com.example.jjscheckmate.service.OnClickWithOnTouchListener;
import com.example.jjscheckmate.service.WordleClickedActivity;
...
//                    Toast.makeText(getContext(),arg, Toast.LENGTH_SHORT).show();
                    Log.d("mawang","HomeFragment AndroidBridge getClickedWord - arg = "+arg);
...
//                            progressBar.setVisibility(View.GONE);
                            ...
                            d3.loadUrl("file:///android_asset/d3.html"); // ok
...
//                    Log.d("mawang","HomeFragment getSurveyTitles - response = "+response);
//                    Log.d("mawang","HomeFragment getSurveyTitles - response.body() = "+response.body());
//                    Log.d("mawang","HomeFragment getSurveyTitles - datas size= "+datas.size());
                    ...
                    isFinish = true;
//                    Log.d("mawang","HomeFragment getSurveyTitles - pass here");
                }
            }
            @Override
            public void onFailure(retrofit2.Call<ArrayList<SurveyDTO>> call, Throwable t) {
                Log.d("mawang","HomeFragment getSurveyTitles - onFailure = "+t.getMessage());
            }
        });
