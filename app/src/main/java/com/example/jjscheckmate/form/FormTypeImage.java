...
public class FormTypeImage extends FormAbstract {
    ...
    private int formComponent_id; // 꼭써야하나
...
//        Log.d("mawang", "FormTypeImage copy 생성자 - file = " + file);
//        Log.d("mawang", "FormTypeImage copy 생성자 - uri = " + uri);
//        Log.d("mawang", "FormTypeImage copy 생성자 - IsPoseted = " + IsPoseted);
//        Log.d("mawang", "FormTypeImage copy 생성자 - formComponent_id = " + formComponent_id);
    }

    public String getImagePath(Uri uri) {
//        Log.d("mawang", "FormTypeImage getImagePath - uri : " + uri.toString());
...
//어느쪽이 실행되는걸까? 대부분이 세그먼트식이네
        if (pathType(uri)) {
            ...
            String type = split[0];
//            Log.d("mawang", "FormTypeImage getImagePath - 도큐먼트 docId: " + docId);
//            Log.d("mawang", "FormTypeImage getImagePath - 도큐먼트 split: " + split);
//            Log.d("mawang", "FormTypeImage getImagePath - 도큐먼트 type: " + type);

            Uri contentUri = null;
            if ("image".equals(type)) {
                contentUri = MediaStore.Images.Media.EXTERNAL_CONTENT_URI;
            }
//            Log.d("mawang", "FormTypeImage getImagePath - 도큐먼트 contentUri: " + contentUri);

            String selection = MediaStore.Images.Media._ID + "=?";
            String[] selectionargs = new String[]{split[1]};
//            Log.d("mawang", "FormTypeImage getImagePath - 도큐먼트 selectionargs: " + selectionargs);
            String columm = "_data";
            String[] proj = {columm};
            ...
            Log.d("mawang", "FormTypeImage getImagePath - 도큐먼트 filePath: " + filePath);
            ...
            //Log.d("mawang", "FormTypeImage getImagePath - 세그먼트 selectionargs: " + selectionargs);
            String columm = "_data";
            String[] proj = {columm};
...
//            Log.d("mawang", "FormTypeImage getImagePath - 세그먼트 filePath: " + filePath);
            cursor.close();
            return filePath;
        }
...
//        Log.d("mawang", "FormTypeImage setDataUri - uri = " + uri);
//        Log.d("mawang", "FormTypeImage setDataUri - IsPoseted = " + IsPoseted);
