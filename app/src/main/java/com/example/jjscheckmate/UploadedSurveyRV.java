...
import com.example.jjscheckmate.mainActivityViwePager.MainVPMySurveyFragment;
...
//                    Intent intent = new Intent(mContext, reserve_UploadedFormEditableActivity.class);
...
//        Log.d("mawang", "UploadedSurveyRV datasClear - called");
    ...
    public void setDatas(ArrayList<UploadedSurveyDTO> datas) {
        this.datas = datas;
        this.notifyDataSetChanged(); // work
    }
